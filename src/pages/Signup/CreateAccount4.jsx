...
function CreateAccount4() {
  ...
  return (
    <Modal>
      <div className="flex h-screen flex-shrink-0 flex-col items-start justify-between bg-black px-[15px] pb-5 font-inter text-twitter-neutral-50 md:h-[475px] md:w-[512px] md:rounded-2xl md:py-5">
